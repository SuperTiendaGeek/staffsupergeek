    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-3 py-5">
      <form onSubmit={handleSubmit} className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-[1rem] border border-[#3A3A36] bg-[#252622] p-5 shadow-xl">
        <div className="flex items-start justify-between gap-2">
          <div>
            <h3 className="text-base font-semibold text-[#F5F5F5]">Anular pago</h3>
            <p className="mt-0.5 text-sm text-[#A7A7A7]">El pago no se eliminará; quedará marcado como anulado.</p>
          </div>
          <button
            type="button"
  ...
  return (
    <>
      <button
        ...
        className="text-sm font-semibold text-red-300 transition hover:text-red-100"
      >
        Anular
      </button>
