...
export const SHIPPING_V2_SCHEMA_GENERATED_AT = "2026-09-19T11:58:57.802Z";
...
export const SHIPPING_V2_EXPECTED_ITEM_FIELDS_VALIDATION = {
  ...
  "found": [
    ...
    "Reservas",
    "Texto Facebook",
    "Texto Facebook fórmula legacy",
    "Facebook Super Geek",
    "Cantidad Reservada",
    "Recibido",
    "GPU Integrada",
    "Shipping Intervenciones",
    "Almacenamiento 2",
    "Almacenamiento 2 tipo",
    "Revisión técnica detalle",
    "Puntos de revisión fallidos"
  ],
  "missing": [],
  "similar": {}
} as const;
